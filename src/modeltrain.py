...
class Recommender(object):
    ...
    def _initialize(self, interactions):
        ...
        self._net = Model(self._num_users,
                          self._num_items,
...
if __name__ == '__main__':
    ...
    # data arguments
    parser.add_argument('--train_root', type=str, default='../data/train.csv')
    parser.add_argument('--test_root', type=str, default='../data/test.csv')
    ...
    model_parser.add_argument('--n_l', type=int, default=50)
    ...
    # load dataset
    train = Interactions2(config.train_root)
    # transform triplets to sequence representation
    train.to_sequence(config.L, config.T)

    test = Interactions2(config.test_root,
